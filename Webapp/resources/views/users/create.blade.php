...
<div class="card shadow-lg p-4 mx-auto mt-5 align-items-center rounded-5" style="width:fit-content;min-width:550px;height:fit-content; background-color:rgba(255,255,255,0.5)">
    ...
    @endif
        ...
        <div class="mb-3" style="font-weight:500">
            ...
            <input type="email" class="form-control" id="email" name="email" placeholder="Vul hier het IWA e-mailadres in" required>
        </div>
        ...
        <div class="mb-3" style="font-weight:500">
            ...
            <input type="text" class="form-control" id="employee_code" name="employee_code" placeholder="Vul hier een personeelscode in" required>
        </div>

        <div class="mb-3" style="font-weight:500">
            <label for="password" class="form-label">Wachtwoord *</label>
            <input type="password" class="form-control" id="password" name="password" placeholder="Vul hier het wachtwoord in" required>
        </div>

        <div class="mb-3" style="font-weight:500">
            <label for="password_confirmation" class="form-label">Herhaal wachtwoord *</label>
            <input type="password" class="form-control" id="password_confirmation" name="password_confirmation" placeholder="Herhaal het wachtwoord" required>
        </div>
