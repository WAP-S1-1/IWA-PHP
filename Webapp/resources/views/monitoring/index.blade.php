...
@section('content')
    ...
    <style>
        body { background-image: url('background-sky.jpg'); }
        .stations-card{
            width: 18rem;
            margin: 1rem;
        ...
        #stations-scroll { max-height: 100%; overflow-y: auto; }
        .location-text { display: inline-block; max-width: 10rem; word-wrap: break-word; overflow: hidden; }
    ...
    <div class="card shadow-lg p-4 mx-auto align-items-center rounded-bottom-4" style="width:1600px;height:700px; background-color:rgba(255,255,255,0.5)">
        <div class="w-100" id="stations-scroll">
            <div id="stations-container" class="row g-3 justify-content-center">
